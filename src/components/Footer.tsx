    ...
    <footer className="w-full border-t border-slate-700 bg-black">
      <div className="mx-auto max-w-screen px-3 py-3">
        <div
          ...
          "
        >
          {/* Texto corto en mobile, largo desde sm */}
          <span className="sm:hidden">© {year} · by</span>
          <span className="hidden sm:inline">
            © {year} · Built with passion and dedication by
          </span>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 sm:gap-2 text-[#1280ff] hover:text-sky-400 transition-colors"
          >
            <svg
          ...
          >
            ...
            <span className="font-medium">Tobías</span>
          </a>
        </div>
      </div>
    </footer>
