...
export const sectionsEn: Record<string, ReactNode> = {
  Overview: (
    <>
      ...
      <ul className="list-disc pl-6">
        <li>Visual routing differences (curves vs straight lines in ERDPlus new).</li>
        <li>Proprietary IDs from non-ERDPlus tools can’t be preserved (invisible).</li>
        <li>Conversion depends on ERDPlus spec adherence.</li>
      </ul>
      <p>
